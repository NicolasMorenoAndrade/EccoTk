...
proc ::EccoTk::buscarActualizar {path} {
...
proc ::EccoTk::ComboBoxAutoComplete {path key} {
	...
	variable listaColegios $EccoTk::listaColegios
	$path configure -values $listaColegios	
	...
	set actualizados [EccoTk::buscarActualizar $path]
